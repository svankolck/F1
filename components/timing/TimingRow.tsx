...
export default function TimingRow({ row }: TimingRowProps) {
    return (
        <tr className="border-b border-f1-border/40 odd:bg-white/[0.02] transition-all duration-300">
            <td className="py-2.5 px-2 text-xs md:text-sm font-mono font-bold">P{row.position}</td>
            <td className="py-2.5 px-2">
                <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: row.teamColor }} />
            ...
            <td className="py-2.5 px-2 text-xs font-mono">{row.lastLap}</td>
            <td className="hidden md:table-cell py-2.5 px-2 text-xs font-mono">{row.sector1}</td>
            <td className="hidden md:table-cell py-2.5 px-2 text-xs font-mono">{row.sector2}</td>
            <td className="hidden md:table-cell py-2.5 px-2 text-xs font-mono">{row.sector3}</td>
            <td className="py-2.5 px-2 text-xs font-mono">{row.pitStops}</td>
